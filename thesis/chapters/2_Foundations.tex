...
Each layer consists of nodes that are loosely patterned on a neuron in the human brain.
Figure \ref{fig:dnn_example} shows a fully connected deep neural network with three hidden layers.

\begin{figure}[H]
    \centering
    \includegraphics[scale=.6]{tikz41}
    \caption{\cite{dnn_example_image} Example of an deep neural network}
...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{Procedure of each node}
