...
\newline
Figure \ref{fig:catastrophic_forgetting_clarification} shows an propositional network representing artithmetic facts.
The network structue and connections in Figure \ref{fig:catastrophic_forgetting_clarification}A represent two facts, $5 + 4 = 9$ and $6 + 4 = 10$.
The learning of a new fact innvolves an exntension to the current propositional structure.
...
Thus, the adjustement of the structure, to be able to respond correctly to the new disred inputs, results in a forgetting of old knowledge.
\cite{psychology_learning_mccloskey_cohen}
