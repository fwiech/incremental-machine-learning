...
In fact, many methods like EWC, BWC or IMM use the diagonal assumption of the FIM.
...
The MNIST dataset is used to train the network and to create multiple sequential learning tasks (SLTs).
...
\subsubsection*{Disjoint SLTs - D9-1}

In this experiment the MNIST dataset is disjointed.
The first task $T_1$ contains nine randomly selected classes.
The remaining class defines the task $T_2$.

\subsubsection*{Disjoint SLTs - D5-5}
