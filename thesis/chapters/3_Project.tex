...
Before adapting the \acrshort{ewc} algorithm, the codebase has to proof that it delivers the results of the \acrshort{ewc} paper.
The original \acrshort{ewc} algorithm is tested in the constructed benchmarks described in Project Goals (Section \ref{project_goals}):
...
For convenience this article uses the shorthand \acrfull{gm} for the new matrix operation.
\newline
