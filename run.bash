...
#setup for 9-1!
python3 src/main.py --classes 0 1 2 3 4 5 6 7 8  --learnrate 0.001 --iterations 2500 --batch 100 --batch_fisher 1000 -s FISH1
python3 src/main.py --classes 9 --learnrate 0.00001 --lambda 1000000 --iterations 2500 --batch 100 --previous FISH1
